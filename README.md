...
This will generate a [contract artifact](https://github.com/defi-wonderland/aztec-token/tree/dev/src/contracts) and TypeScript class for the Aztec smart contract in `src/contracts/main.nr`, which the frontend uses to generate the UI.
